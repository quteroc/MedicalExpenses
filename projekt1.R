...
p1 <- wypisaniZmarliJoined %>% 
  ...
  annotate("text",x=5,y=0.023,label="Pandemia Covid-19",size=2.5,color="blue",fontface="bold")+
  geom_point()+
  geom_line()+
...
wypisaniZmarliJoined %>% 
  ggplot(aes(x=TABL..14.,y=Ratio,fill = Year))+
  geom_col(position="dodge")+
  theme(axis.text.x = element_text(angle = 45,hjust=1))+
  labs(title="Stosunek zmarłych i wypisanych pacjentów", subtitle = "Zp odziałem na województwa",x="Województwa",y="Stosunek")+
  scale_fill_discrete(name="Rok",labels=c("2019","2020","2021","2022","2023"))
...
wypisaniZmarliJoined %>% 
  ...
  geom_col(position="dodge")+
  theme(axis.text.x = element_text(angle = 45,hjust=1))+
  labs(title="Stosunek zmarłych i wypisanych pacjentów", subtitle = "Z podziałem na województwa",x="Województwa",y="Stosunek")+
  scale_fill_discrete(name="Rok",labels=c("2019","2020","2021","2022","2023"))
